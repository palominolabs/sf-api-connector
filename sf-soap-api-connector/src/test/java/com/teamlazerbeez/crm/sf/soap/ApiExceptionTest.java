...
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.ApiFault;
...
public class ApiExceptionTest {
    ...
    public void testToStringWithNullFaultCode() {
        ...
        assertEquals("com.teamlazerbeez.crm.sf.soap.ApiException: msg {username='username'}", exc.toString());
    }
    ...
    public void testToStringWithFaultCode() {
        ...
        assertEquals(
                "com.teamlazerbeez.crm.sf.soap.ApiException: msg {username='user', faultCode=API_CURRENTLY_DISABLED, faultMessage='excMsg', row=null, column=null}",
                ex.toString());
    }
}
