...
public final class ProfileObjectPermissions {
    ...
    @Nonnull
    com.teamlazerbeez.crm.sf.soap.jaxwsstub.metadata.ProfileObjectPermissions getStub() {
        final com.teamlazerbeez.crm.sf.soap.jaxwsstub.metadata.ProfileObjectPermissions stub =
                new com.teamlazerbeez.crm.sf.soap.jaxwsstub.metadata.ProfileObjectPermissions();
