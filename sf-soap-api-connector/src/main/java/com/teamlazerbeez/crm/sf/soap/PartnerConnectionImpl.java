...
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.Create;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.CreateResponse;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.Delete;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.DeleteResponse;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.DeleteResultType;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.DescribeGlobal;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.DescribeGlobalResponse;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.DescribeGlobalResultType;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.DescribeSObjectResultType;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.DescribeSObjects;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.DescribeSObjectsResponse;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.EmptyRecycleBin;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.EmptyRecycleBinResponse;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.EmptyRecycleBinResultType;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.ExceptionCode;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.GetServerTimestamp;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.GetServerTimestampResponse;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.GetServerTimestampResultType;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.GetUserInfo;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.GetUserInfoResponse;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.InvalidFieldFault_Exception;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.InvalidIdFault_Exception;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.InvalidQueryLocatorFault_Exception;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.InvalidSObjectFault_Exception;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.Logout;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.LogoutResponse;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.MalformedQueryFault_Exception;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.Query;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.QueryAll;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.QueryAllResponse;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.QueryMore;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.QueryMoreResponse;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.QueryResponse;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.QueryResultType;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.Retrieve;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.RetrieveResponse;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.SaveResultType;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.Soap;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.Undelete;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.UndeleteResponse;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.UndeleteResultType;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.UnexpectedErrorFault_Exception;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.Update;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.UpdateResponse;
...
final class PartnerConnectionImpl extends AbstractSalesforceConnection implements PartnerConnection {
    ...
    public synchronized List<SaveResult> create(@Nonnull List<SObject> sObjects) throws ApiException {
        ...
        List<com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.SObject> stubSObjects = createParam.getSObjects();
    ...
    public synchronized List<SObject> retrieve(@Nonnull String sObjectType, @Nonnull List<Id> ids,
        ...
        List<com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.SObject> stubSObjects = response.getResult();
    ...
    public synchronized List<SaveResult> update(@Nonnull List<SObject> sObjects) throws ApiException {
        ...
        List<com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.SObject> stubSObjectList = param.getSObjects();
    ...
    private void writeSObjectsToStubSObjectList(List<SObject> sObjects,
            List<com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.SObject> stubSObjectList)
            throws ApiException {
    ...
    private List<PartnerSObject> getSObjectsFromStubs(
            List<com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.SObject> stubs)
            throws ApiException {
        try {
