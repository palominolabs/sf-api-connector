...
public final class DescribeMetadataResult {
     ...
     */
    DescribeMetadataResult(com.teamlazerbeez.crm.sf.soap.jaxwsstub.metadata.DescribeMetadataResult stub) {
        ...
        for (com.teamlazerbeez.crm.sf.soap.jaxwsstub.metadata.DescribeMetadataObject objectStub : stub
                .getMetadataObjects()) {
