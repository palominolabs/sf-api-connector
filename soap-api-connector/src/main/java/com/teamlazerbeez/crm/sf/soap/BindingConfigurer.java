...
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.apex.DebuggingHeader;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.apex.LogCategory;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.apex.LogCategoryLevel;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.apex.LogInfo;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.apex.LogType;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.metadata.MetadataPortType;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.CallOptions;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.InvalidIdFault_Exception;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.Login;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.LoginFault_Exception;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.LoginResponse;
import com.teamlazerbeez.crm.sf.soap.jaxwsstub.partner.LoginResultType;
...
final class BindingConfigurer {
    ...
    void configureMetadataBinding(@Nonnull MetadataPortType metadataBinding,
        ...
        com.teamlazerbeez.crm.sf.soap.jaxwsstub.metadata.SessionHeader sessionHeader =
                new com.teamlazerbeez.crm.sf.soap.jaxwsstub.metadata.SessionHeader();
        sessionHeader.setSessionId(bindingConfig.getSessionId());

        List<Header> headers = new ArrayList<Header>();

        com.teamlazerbeez.crm.sf.soap.jaxwsstub.metadata.CallOptions metadataCallOpts =
                new com.teamlazerbeez.crm.sf.soap.jaxwsstub.metadata.CallOptions();
    ...
    void configureApexBinding(ApexPortType binding, BindingConfig bindingConfig) {
        ...
        // Set the session Id in the header
        com.teamlazerbeez.crm.sf.soap.jaxwsstub.apex.SessionHeader sessionHeader =
                new com.teamlazerbeez.crm.sf.soap.jaxwsstub.apex.SessionHeader();
        sessionHeader.setSessionId(bindingConfig.getSessionId());

        List<Header> headers = new ArrayList<Header>();

        com.teamlazerbeez.crm.sf.soap.jaxwsstub.apex.CallOptions apexCallOpts =
                new com.teamlazerbeez.crm.sf.soap.jaxwsstub.apex.CallOptions();
