...
public final class RetrieveResult {
     ...
     */
    RetrieveResult(com.teamlazerbeez.crm.sf.soap.jaxwsstub.metadata.RetrieveResult stubResult) {

        final List<FileProperties> list = new ArrayList<FileProperties>();

        for (com.teamlazerbeez.crm.sf.soap.jaxwsstub.metadata.FileProperties stubProperties : stubResult
                .getFileProperties()) {
        ...
        for (com.teamlazerbeez.crm.sf.soap.jaxwsstub.metadata.RetrieveMessage stubMessage : stubResult.getMessages()) {
