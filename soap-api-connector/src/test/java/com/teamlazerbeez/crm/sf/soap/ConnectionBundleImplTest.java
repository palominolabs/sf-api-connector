...
import com.teamlazerbeez.testutil.ReflectionUtil;
...
public class ConnectionBundleImplTest {
    ...
    public void testChangingCredentialsClearsConfigData() throws ApiException {
        ...
        this.bundle.updateCredentials(
                ...
                ConnectionTestSfUserProps.getPropVal("com.teamlazerbeez.test.crm.sf.conn.org1AltUser.sfPassword"), 4);
    ...
    public void testReconfigureWithUpdatedCredentialsUsesNewUsername() throws ApiException {
        ...
        String newUser = ConnectionTestSfUserProps.getPropVal("com.teamlazerbeez.test.crm.sf.conn.org1AltUser.sfLogin");
        String newPass =
    ...
    public void testReconfigureWithAnotherOrgsCredsFails()
        ...
        this.bundle.updateCredentials(
                ConnectionTestSfUserProps.getPropVal("com.teamlazerbeez.test.crm.sf.conn.metadata.user"),
                ConnectionTestSfUserProps.getPropVal("com.teamlazerbeez.test.crm.sf.conn.metadata.password"), 10);
