...
public class SObjectDescriptionTest {
    ...
    @Before
    public void setUp() {
        String user = ConnectionTestSfUserProps.getPropVal("com.teamlazerbeez.test.crm.sf.util.sfLogin");
        String passwd = ConnectionTestSfUserProps.getPropVal("com.teamlazerbeez.test.crm.sf.util.sfPassword");
